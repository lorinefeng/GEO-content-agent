...
import { ensureAuthTables, ensureDefaultAdmin, findActiveUserById, rejectRegistrationRequest } from '@/lib/authDb';
...
export async function POST(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  const result = await rejectRegistrationRequest(db, id, admin.id);
